...
final class SourceHealthTests: XCTestCase {
    ...
    func testBackendAPICoverageStaysSplitAcrossFocusedTestFiles() throws {
        ...
        XCTAssertTrue(chatTests.contains("testChatBackendUsesSavedOpenAIKeyForOpenAIProviderRequest"))
    ...
    func testAppStoreSubmissionChecklistGatesReleaseEvidence() throws {
        ...
        XCTAssertTrue(releaseHygiene.contains("sk-[A-Za-z0-9_-]{20,}"))
        XCTAssertTrue(releaseHygiene.contains("ghp_[A-Za-z0-9_]{20,}"))
        XCTAssertTrue(releaseHygiene.contains("github_pat_"))
        XCTAssertTrue(releaseHygiene.contains("xox[baprs]-[A-Za-z0-9-]{10,}"))
        XCTAssertTrue(releaseHygiene.contains("-----BEGIN (RSA|OPENSSH|EC|DSA|PRIVATE) KEY-----"))
        XCTAssertTrue(releaseHygiene.contains("refresh[_-]token"))
        XCTAssertTrue(releaseHygiene.contains("access[_-]token"))
        XCTAssertTrue(releaseHygiene.contains("client[_-]secret"))
        XCTAssertTrue(releaseHygiene.contains("--glob '!/.git/**'"))
        XCTAssertTrue(releaseHygiene.contains("--glob '!/.build/**'"))
        XCTAssertTrue(releaseHygiene.contains("--glob '!tmp/screenshots/**'"))
        XCTAssertTrue(releaseHygiene.contains("--glob '!Kairo.xcodeproj/project.xcworkspace/xcuserdata/**'"))
