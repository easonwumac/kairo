...
final class KairoCoreTests: XCTestCase {
    ...
    func testPermissionHubDefinesHomeKitDemoAccessibilityIdentifiers() throws {
        ...
        XCTAssertTrue(permissionHubView.contains(#""access.skill.\(skill.id).homekit-boundary""#))
    ...
    func testUITestScenarioCatalogCoversCoreAppSmokeFlows() {
        ...
        XCTAssertTrue(catalog.scenario(id: "access-homekit-demos")?.requiredAccessibilityIdentifiers.contains("access.skill.homekit-front-door-lock.homekit-boundary") == true)
