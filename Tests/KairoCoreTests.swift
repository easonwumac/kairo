...
final class KairoCoreTests: XCTestCase {
    ...
    func testSettingsViewDelegatesCompactModelsOnlyLayout() throws {
        ...
        XCTAssertTrue(compactView.contains("private let popularModelRowLimit = 3"))
        ...
        XCTAssertTrue(compactView.contains("Starter set: Qwen first, plus a short popular fallback list."))
        XCTAssertTrue(compactView.contains("private var compactSectionTitleFont: Font { .system(size: 15, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains("private var compactSectionHeadingFont: Font { .system(size: 11, weight: .semibold) }"))
