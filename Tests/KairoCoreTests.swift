...
final class KairoCoreTests: XCTestCase {
    ...
    func testModelCatalogWebsiteDocumentsNoWeightsPolicy() throws {
        ...
        XCTAssertTrue(indexHTML.contains("font-size: 11px"))
    ...
    func testSettingsViewDelegatesCompactModelsOnlyLayout() throws {
        ...
        XCTAssertTrue(compactView.contains("Starter set: Qwen first, plus one popular fallback."))
        XCTAssertTrue(compactView.contains("private var compactSectionTitleFont: Font { .system(size: 14, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains("private var compactSectionHeadingFont: Font { .system(size: 10, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains("private var compactModelNameFont: Font { .system(size: 9, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains("private var compactModelMetadataFont: Font { .system(size: 7.5) }"))
        XCTAssertTrue(compactView.contains("private var compactModelStatusFont: Font { .system(size: 7.5, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains("private var compactButtonLabelFont: Font { .system(size: 7.5, weight: .semibold) }"))
        XCTAssertTrue(compactView.contains(#""Reply""#))
        XCTAssertFalse(compactView.contains(#""Reply Check""#))
        XCTAssertTrue(compactView.contains("GridItem(.adaptive(minimum: 58)"))
    ...
    func testXcodeProjectDefinesKairoUITestTargetAndSmokeTestFile() throws {
        ...
        XCTAssertTrue(smokeTest.contains("testSettingsLocalModelDownloadRequiresConfirmationPreview"))
        XCTAssertTrue(smokeTest.contains("testSettingsExpandedModelCatalogKeepsPopularStarterRowsVisible"))
        ...
        XCTAssertTrue(smokeTest.contains(#""settings.models.\(modelID).download-preview""#))
        XCTAssertTrue(smokeTest.contains(#""settings.models.\(modelID).download-confirm""#))
        XCTAssertTrue(smokeTest.contains(#""settings.models.\(modelID).download-cancel""#))
        XCTAssertTrue(smokeTest.contains(#""settings.models.qwen3-5-0-8b-q4-k-m.reply-check""#))
        XCTAssertTrue(smokeTest.contains(#"XCTAssertFalse(anyElement("settings.models.show-more").exists)"#))
        XCTAssertTrue(smokeTest.contains(#"XCTAssertFalse(findElement("settings.models.smollm2-1-7b-instruct-q4-k-m.name""#))
        ...
        XCTAssertTrue(smokeTest.contains("testChatCanPreviewAndConfirmMessagesHandoff"))
        XCTAssertTrue(smokeTest.contains(#""chat.proposed-action.openMessageHandoff""#))
        ...
        XCTAssertTrue(smokeTest.contains(#""automations.shortcut-demo.generic-node-runner.preview-result""#))
