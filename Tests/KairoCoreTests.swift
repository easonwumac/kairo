...
final class KairoCoreTests: XCTestCase {
    ...
    func testXcodeProjectDefinesKairoUITestTargetAndSmokeTestFile() throws {
        ...
        XCTAssertTrue(uiTestSources.contains("testAutomationsRecipeCenterPreviewsInternalRecipeAndKeepsActionsSecondary"))
        ...
        XCTAssertTrue(uiTestSources.contains(#""automations.recipe.daily-briefing.more-actions""#))
