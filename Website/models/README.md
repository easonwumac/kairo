...
The seed catalog currently tracks popular GGUF models at 2B parameters or below, including Qwen/Qwen-Coder/Qwen-Math, Llama, Granite, DeepSeek, LFM, H2O Danube, OLMo, SmolLM, Gemma, and StableLM variants. Noncommercial or gated license terms must stay visible and should be enforced by the future standalone `kairo-models` catalog before production rollout.
