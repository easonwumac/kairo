...
The seed catalog intentionally starts with Apache-2.0 local asset-understanding candidates: Gemma 4 E2B IT QAT Q4_0, Qwen2.5 text fallbacks, Qwen2.5-VL 3B, and Gemma 4 E4B IT QAT Q4_0 with projector companion metadata. Larger catalogs can live in the future standalone `kairo-models` repository. Noncommercial, custom, gated, or unclear license terms should stay manual/import-only until Kairo has explicit license approval UI and bundled notices for that family.
