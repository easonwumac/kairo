...
3. Local model release hardening.
   ...
   - Qwen3.5 0.8B GGUF has host macOS `llama.cpp` CLI proof and app-internal iOS Simulator reply-check proof through embedded `llama.xcframework`; keep production iPhone inference marked `Planned` until real-device latency, memory, thermal, and packaging proof exists.
