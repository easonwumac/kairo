...
1. Real-device beta sign-off.
   - Current `xcrun devicectl list devices` check on 2026-06-04 09:16 CST listed all available physical test devices as `unavailable`, so no real-device sign-off was completed in this pass.
