...
- Chat can surface executable local notification actions through `UserNotifications` and reminder actions through EventKit Reminders, but both stay behind visible action preview, runtime permission, and explicit user confirmation.
