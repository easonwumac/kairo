...
- Local-model catalog, verified downloader, install registry, selected-model settings, Settings model catalog/status/preference UI, and provider-routing scaffold.
