...
- XcodeGen UI test target scaffold, UI smoke scenario catalog, deterministic `--ui-testing` Skill Manager environment, Access/HomeKit/Skill Manager interaction coverage, chat notification/reminder/calendar/contact/email-draft/Messages/Apple-Maps action-preview e2e coverage, Shortcut tool-candidate e2e coverage, and stable SwiftUI accessibility identifiers.
