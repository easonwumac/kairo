...
- Chat can surface executable local notification actions through `UserNotifications`, but scheduling stays behind visible action preview, runtime notification permission, and explicit user confirmation.
