...
- Structured Shortcut node runtime, executable official demo recipe runner, Settings demo recipe UI including Email Triage, and App Intents for asking, saving, searching, summarizing, task extraction, draft replies, reminder drafts, daily briefings, and generic node-kind plus JSON input/output chaining.
