...
- Structured Shortcut node runtime, executable official demo recipe runner, Settings demo recipe UI including Email Triage and Request to Recipe Draft, and App Intents for asking, saving, searching, summarizing, task extraction, draft replies, reminder drafts, disabled internal recipe draft previews, daily briefings, and generic node-kind plus JSON input/output chaining.
